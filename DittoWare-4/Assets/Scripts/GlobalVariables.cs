...
public class GlobalVariables : MonoBehaviour
{
    ...
    {
        ////////////////////////////////////////////////////////////////////////////////////////////////////
        SaveData.currentSave.playerName = "Lucas";
        SaveData.currentSave.playerID = 02017;
        ...
        SaveData.currentSave.PC.addPokemon(new Pokemon(011, Pokemon.Gender.CALCULATE, 9, "Great Ball", "", "Gold", 0));
        ...
        SaveData.currentSave.PC.addPokemon(new Pokemon(395, null, Pokemon.Gender.FEMALE, 36, false, "Ultra Ball",
            "", SaveData.currentSave.playerName,
            31, 31, 31, 31, 31, 31, 0, 252, 0, 0, 0, 252, "JOLLY", 0,
            new string[] { "Night Slash", "Surf", "Headbutt", "Ice Beam" }, new int[] { 0, 0, 0, 3 }));
        ...
        SaveData.currentSave.Bag.addItem("Rare Candy", 999);

        SaveData.currentSave.Bag.addItem("Dazzling Gleam", 1);
    ...
    public void updateResolution()
    {
        ...
        {
            Screen.SetResolution(256 * PlayerPrefs.GetInt("screenSize"), 192 * 2 * PlayerPrefs.GetInt("screenSize"), false);
        }
        else if (PlayerPrefs.GetInt("fullscreen") == 1)
        {
            Screen.SetResolution(256 * PlayerPrefs.GetInt("screenSize"), 192 * 2 * PlayerPrefs.GetInt("screenSize"), true);
        }
        else
        {
            int resWidth = Screen.currentResolution.width + 10; //add a buffer  orig value: + 10
            int resHeight = Screen.currentResolution.height + 6;//orig value: + 6
            int maxSize = 1;
            ...
            Screen.SetResolution(256 * maxSize, 192 * 2 * maxSize, true);
        }
    }
