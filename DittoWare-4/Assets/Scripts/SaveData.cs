...
public class SaveData
{
    ...
    public int playerStarterChoice; //What starter did the player pick: 0 = Turtwig; 1 = Chimchar; 2 = Piplup

    public bool[] gymsEncountered = new bool[12];
    public bool[] gymsBeaten = new bool[12];
    public string[] gymsBeatTime = new string[12];

    //Important rival data
    public string rivalName;

    //Important rival 2 data
    public string rival2Name;
    public bool isRival2Male;  //is rival 2 Lyra or Ethan
