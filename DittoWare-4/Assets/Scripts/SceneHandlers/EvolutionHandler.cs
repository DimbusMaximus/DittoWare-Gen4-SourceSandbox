...
public class EvolutionHandler : MonoBehaviour
{
    ...
    public IEnumerator control(Pokemon pokemonToEvolve, string methodOfEvolution)
    {
        ...
        pokemonSprite.rectTransform.sizeDelta = new Vector2(80, 80);
        ...
        topBorder.rectTransform.sizeDelta = new Vector2(256, 0);
        bottomBorder.rectTransform.sizeDelta = new Vector2(256, 0);
        ...
        while (evolving)
        {
            if (Input.GetButtonDown("Back") || CrossPlatformInputManager.GetButtonDown("B"))
            {
                evolving = false;
        ...
        if (evolved)
        {
            ...
            while (running)
            {
                if (Input.GetButtonDown("Select") || Input.GetButtonDown("Back") || CrossPlatformInputManager.GetButtonDown("A") || CrossPlatformInputManager.GetButtonDown("B"))
                {
                    running = false;
                }
    ...
    private IEnumerator pokemonPulsate(int repetitions)
    {
        ...
        for (int i = 0; i < repetitions; i++)
        {
            ...
            while (increment < 1)
            {
                ...
                {
                    pokemonSprite.rectTransform.sizeDelta = new Vector2(80f * increment, 80f * increment);
                    ...
                    evolutionSprite.rectTransform.sizeDelta = new Vector2(80f - 80f * increment,
                        80f - 80f * increment);
                ...
                {
                    pokemonSprite.rectTransform.sizeDelta = new Vector2(80f - 80f * increment, 80f - 80f * increment);
                    pokemonSprite.transform.localPosition = new Vector3(originalPosition.x,
                        originalPosition.y + (distance * increment), originalPosition.z);
                    evolutionSprite.rectTransform.sizeDelta = new Vector2(80f * increment, 80f * increment);
                    evolutionSprite.transform.localPosition = new Vector3(originalPosition.x,
                        centerPosition.y - (distance * increment), originalPosition.z);
                }
                yield return null;
    ...
    private IEnumerator borderDescend()
    {
        ...
        while (increment < 1)
        {
            ...
            topBorder.rectTransform.sizeDelta = new Vector2(256, 32 * increment);
            bottomBorder.rectTransform.sizeDelta = new Vector2(256, 32 * increment);
            yield return null;
        }
    }
    ...
    private IEnumerator borderRetract()
    {
        ...
        while (increment < 1)
        {
            ...
            topBorder.rectTransform.sizeDelta = new Vector2(256, 32 - 32 * increment);
            bottomBorder.rectTransform.sizeDelta = new Vector2(256, 32 - 32 * increment);
            yield return null;
        }
    }
    ...
    {
        Vector2 vector = new Vector2(x * 256f - 128f, (1 - y) * 192f - 96f);
        return vector;
    }
