...
public class SettingsHandler : MonoBehaviour
{
    ...
    private void updateResolutions()
    {
        ...
        int resWidth = Screen.currentResolution.width; //add a buffer
        int resHeight = Screen.currentResolution.height;
        if (1280 < resWidth && 960 * 2 < resHeight)
        {
            screenSize.text = "x1     x2     x3     x4     x5";
            selectedOptionSize[6] = 5;
        }
        else if (1024 < resWidth && 768 * 2 < resHeight)
        {
            screenSize.text = "x1     x2     x3     x4";
            selectedOptionSize[6] = 4;
        }
        else if (768 < resWidth && 576 * 2 < resHeight)
        {
            screenSize.text = "x1     x2     x3";
            selectedOptionSize[6] = 3;
        }
        else if (512 < resWidth &&  384 * 2 < resHeight)
        {
    ...
    private void updateOption()
    {
        ...
        else if (selectedOption == 4)
        {
            if (selectedOptionIndex[selectedOption] == 0)
            {
                ...
                battleSceneHighlight.pixelOffset = new Vector2(186, 99);
            }
            else
            {
                battleSceneHighlight.text = "On";
                battleSceneHighlight.pixelOffset = new Vector2(217, 99);
            }
        }
        else if (selectedOption == 5)
        {
            if (selectedOptionIndex[selectedOption] == 0)
            {
                ...
                battleStyleHighlight.pixelOffset = new Vector2(171, 83);
            }
            else
            {
                battleStyleHighlight.text = "Set";
                battleStyleHighlight.pixelOffset = new Vector2(217, 83);
            }
        }
        else if (selectedOption == 6)
        {
            ...
            else if (selectedOptionIndex[selectedOption] == 1)
            {
                ...
                if (!Screen.fullScreen)
                {
                    Screen.SetResolution(256*2, 384*2, Screen.fullScreen);
                }
            }
            else if (selectedOptionIndex[selectedOption] == 2)
            {
                ...
                if (!Screen.fullScreen)
                {
                    Screen.SetResolution(256*3, 576*2, Screen.fullScreen);
                }
            }
            else if (selectedOptionIndex[selectedOption] == 3)
            {
                ...
                if (!Screen.fullScreen)
                {
                    Screen.SetResolution(256*4, 768*2, Screen.fullScreen);
                }
            }
            else
            {
                ...
                if (!Screen.fullScreen)
                {
                    Screen.SetResolution(256*5, 960*2, Screen.fullScreen);
                }
            }
        }
        else if (selectedOption == 7)
        {
            if (selectedOptionIndex[selectedOption] == 0)
            {
                ...
                fullscreenHighlight.pixelOffset = new Vector2(149, 51);
                Screen.SetResolution(256 * (selectedOptionIndex[6] + 1), 384 * (selectedOptionIndex[6] + 1), false);
            }
            else if (selectedOptionIndex[selectedOption] == 1)
            {
                fullscreenHighlight.text = "Border";
                fullscreenHighlight.pixelOffset = new Vector2(180, 51);
                Screen.SetResolution(256 * (selectedOptionIndex[6] + 1), 384 * (selectedOptionIndex[6] + 1), true);
            }
            else if (selectedOptionIndex[selectedOption] == 2)
            {
                fullscreenHighlight.text = "Stretch";
                fullscreenHighlight.pixelOffset = new Vector2(231, 51);
                Screen.SetResolution(256 * selectedOptionSize[6], 384 * selectedOptionSize[6], true);
            }
        }
    }
...
//		float originalSVol = PlayerPrefs.GetFloat("sfxVolume");
        selectedOption = 0;
        selectRow.pixelInset = new Rect(51, 150, selectRow.pixelInset.width, selectRow.pixelInset.height);
        drawDialogBox();
        ...
        while (running)
        {
            ...
            else if (Input.GetButton("Back") || CrossPlatformInputManager.GetButtonDown("B"))
            {
                Dialog.drawDialogBox();
                yield return
                    Dialog.StartCoroutine("drawText", "Would you like to save the currently \\selected settings?");
                Dialog.drawChoiceBox(48);
                yield return new WaitForSeconds(0.2f);
