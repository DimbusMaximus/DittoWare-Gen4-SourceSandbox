...
public class DialogBoxHandler : MonoBehaviour
{
    ...
    private GUIText DialogBoxTextShadow2;
    private GUIText DialogBoxTextShadow3;
    ...
    private GUIText ChoiceBoxTextShadow2;
    private GUIText ChoiceBoxTextShadow3;
    ...
    void Awake()
    {
        ...
        //link the DialogBoxTextShadow variables to the Text Component
        DialogBoxTextShadow = DialogBox.transform.Find("BoxTextShadow").GetComponent<GUIText>();
        DialogBoxTextShadow2 = DialogBox.transform.Find("BoxTextShadow2").GetComponent<GUIText>();
        DialogBoxTextShadow3 = DialogBox.transform.Find("BoxTextShadow3").GetComponent<GUIText>();
    ...
    public void drawDialogBox(int lines)
    {
        ...
        DialogBoxText.text = "";
        DialogBoxText.color = new Color(82/255f, 82/255f, 90/255f, 1f);
        DialogBoxTextShadow.text = "";
        DialogBoxTextShadow2.text = "";
        DialogBoxTextShadow3.text = "";
        ...
        DialogBoxTextShadow2.pixelOffset = new Vector2(DialogBoxTextShadow2.pixelOffset.x, DialogBoxTextShadow2.pixelOffset.y);
        DialogBoxTextShadow3.pixelOffset = new Vector2(DialogBoxTextShadow3.pixelOffset.x, DialogBoxTextShadow3.pixelOffset.y);*/
    }
    ...
    public void drawChoiceBox(int customYOffset)
    {
        ...
        ChoiceBoxTexture.pixelInset = new Rect(256 - defaultChoiceWidth - 1, defaultChoiceY + customYOffset,
            defaultChoiceWidth, 44f);
        ChoiceBoxSelect.pixelInset = new Rect(256 - defaultChoiceWidth + 7, ChoiceBoxTexture.pixelInset.y + 9f,
            ChoiceBoxSelect.pixelInset.width, ChoiceBoxSelect.pixelInset.height);
        ChoiceBoxText.pixelOffset = new Vector2(256 - defaultChoiceWidth + 21, ChoiceBoxTexture.pixelInset.y + 13f);
        ChoiceBoxTextShadow.pixelOffset = new Vector2(256 - defaultChoiceWidth + 22, ChoiceBoxTexture.pixelInset.y + 12f);
    ...
    public void drawChoiceBoxNo()
    {
        ...
        ChoiceBox.SetActive(true);
        ChoiceBoxTexture.texture = Resources.Load<Texture>("Frame/choice" + PlayerPrefs.GetInt("frameStyle"));
        ChoiceBoxTexture.pixelInset = new Rect(256 - defaultChoiceWidth - 1, defaultChoiceY, defaultChoiceWidth, 44f);
        ChoiceBoxSelect.pixelInset = new Rect(256 - defaultChoiceWidth + 7, ChoiceBoxTexture.pixelInset.y + 9f,
            ChoiceBoxSelect.pixelInset.width, ChoiceBoxSelect.pixelInset.height);
        ChoiceBoxText.pixelOffset = new Vector2(256 - defaultChoiceWidth + 21, ChoiceBoxTexture.pixelInset.y + 13f);
        ChoiceBoxTextShadow.pixelOffset = new Vector2(256 - defaultChoiceWidth + 22, ChoiceBoxTexture.pixelInset.y + 12f);
    ...
    public void drawChoiceBox(string[] choices)
    {
        ChoiceBox.SetActive(true);
        ChoiceBoxTexture.texture = Resources.Load<Texture>("Frame/choice" + PlayerPrefs.GetInt("frameStyle"));
        ChoiceBoxTexture.pixelInset = new Rect(256 - defaultChoiceWidth - 1, defaultChoiceY, defaultChoiceWidth,
            30f + (14f * (choices.Length - 1)));
        ChoiceBoxSelect.pixelInset = new Rect(256 - defaultChoiceWidth + 7,
    ...
    public void drawChoiceBoxWidth(string[] choices, int width)
    {
        ChoiceBox.SetActive(true);
        ChoiceBoxTexture.texture = Resources.Load<Texture>("Frame/choice" + PlayerPrefs.GetInt("frameStyle"));
        ChoiceBoxTexture.pixelInset = new Rect(256 - width - 1, defaultChoiceY, width,
            30f + (14f * (choices.Length - 1)));
        ChoiceBoxSelect.pixelInset = new Rect(256 - width + 7,
            ChoiceBoxTexture.pixelInset.y + 9f + (14f * (choices.Length - 1)), ChoiceBoxSelect.pixelInset.width,
            ChoiceBoxSelect.pixelInset.height);
        ChoiceBoxText.pixelOffset = new Vector2(256 - width + 21, ChoiceBoxTexture.pixelInset.y + 13f);
        ChoiceBoxTextShadow.pixelOffset = new Vector2(256 - width + 22, ChoiceBoxTexture.pixelInset.y + 12f);
        ChoiceBoxText.text = "";
        ChoiceBoxTextShadow.text = "";
        for (int i = 0; i < choices.Length; i++)
        {
    ...
    private IEnumerator drawChar(char character, float secPerChar)
    {
        if (character.Equals('\\'))
        {
            ...
            DialogBoxTextShadow2.text = DialogBoxText.text;
            DialogBoxTextShadow3.text = DialogBoxText.text;
        }
        else
        {
    ...
    public IEnumerator scrollText()
    {
        ...
        while (DialogBoxText.pixelOffset.y < textPosDestination)
        {
            ...
            DialogBoxTextShadow2.pixelOffset = new Vector2(DialogBoxTextShadow2.pixelOffset.x,
                DialogBoxTextShadow2.pixelOffset.y + 1f);
            DialogBoxTextShadow3.pixelOffset = new Vector2(DialogBoxTextShadow3.pixelOffset.x,
                DialogBoxTextShadow3.pixelOffset.y + 1f);
    ...
    public IEnumerator choiceNavigate()
    {
        ...
        while (!selected)
        {
            ...
            else if (Input.GetButtonDown("Back") || CrossPlatformInputManager.GetButtonDown("B"))
            {
                while (chosenIndex > 0)
                {
                    chosenIndex -= 1;
